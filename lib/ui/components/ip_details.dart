import 'package:Mortarvpn/core/https/servers_http.dart';
              ...
              child: FutureBuilder<bool>(
                ...
                builder: (context, snapshot2) {
                  if (snapshot2.connectionState == ConnectionState.waiting &&
                      !snapshot2.hasData) return const SizedBox(height: 150);
            ...
            Column(
              ...
              children: [
                detail(
                  ...
                  valueLead: Image.asset(
                      "icons/flags/png/${ipDetail?.yourFuckingCountryCode.toLowerCase()}.png",
      ...
      child: Column(
        ...
        children: const [
          Align(
              ...
              child: ShimmerObject(height: 14, width: 30)),
          ColumnDivider(space: 5),
          Align(
              alignment: Alignment.centerLeft,
              child: ShimmerObject(height: 14, width: 80)),
        ],
      ),
    );
  }
