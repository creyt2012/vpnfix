import 'package:Mortarvpn/core/models/vpn_config.dart';
...
import 'package:Mortarvpn/ui/components/custom_image.dart';
...
class _ServerItemState extends State<ServerItem>
  ...
  Widget build(BuildContext context) {
    ...
    bool selected =
        VpnProvider.read(context).vpnConfig?.slug == widget.config.slug;
    super.build(context);
